 ...
 * - epoll for event loops and socket events
 * - timerfd for timers
 * - eventfd for user event sources
 * - pthread for thread-safe event raising
 ...
 * - Event-loop-centric resource management using epoll
...
/* ========================================================================
 * LINUX-SPECIFIC RESOURCE STRUCTURES
 * ======================================================================== */
...
/**
 * @brief Linux-specific timer implementation using timerfd
 */
...
/**
 * @brief Linux-specific socket implementation using BSD sockets + epoll
 */
...
/**
 * @brief Linux-specific user event source using eventfd
 */
...
/**
 * @brief Linux-specific event loop using epoll
 */
