...
const char *ptk_err_to_string(ptk_err err) {
    switch(err) {
        ...
        case PTK_ERR_BAD_INTERNAL_STATE: return "Internal state is inconsistent.";
        case PTK_ERR_BUSY: return "Resource is busy.";
        case PTK_ERR_CANCELED: return "Operation was canceled.";
        ...
        case PTK_ERR_SIGNAL: return "Socket operation was signaled/interrupted by external thread.";
