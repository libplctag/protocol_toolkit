...
/* Encode/Decode */
ptk_err {{message.name}}_encode(ptk_allocator_t *alloc, ptk_buf *buf, const {{message.name}}_t *instance);
ptk_err {{message.name}}_decode(ptk_allocator_t *alloc, {{message.name}}_t **instance, ptk_buf *buf);
